...
void release_script_event_listener_callback(ScriptEventListener& listener) {
...
ScriptRuntimeStatistics JerryScriptRuntime::statistics() const {
    ...
    output.event_listener_count = static_cast<std::size_t>(std::count_if(
