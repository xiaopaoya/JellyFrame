...
| Source-aware render performance reports | `render_performance_report_tests.py`, `device_performance_manifest_tests.py`, `device_performance_compare_tests.py`, `embedded_ui_workload_tests.py` |
