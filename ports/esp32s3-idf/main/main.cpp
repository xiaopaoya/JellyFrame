...
#elif CONFIG_JELLYFRAME_ESP32S3_RUN_SCRIPT_TASK_VALUE_FRAME_V4_ACCEPTANCE
    if (!jellyframe_esp32s3::start_script_task_value_frame_v4_acceptance_task()) {
        ESP_LOGE(tag, "failed to start script-task value-frame v4 acceptance fixture");
    } else {
        ESP_LOGI(tag, "script-task value-frame v4 acceptance fixture started");
    }
