...
- packed RGB565 presentation 仍为可选路径。WS147 172x320 在 2026-08-02 的整屏渐变 A/B
  中，packed conversion 的 frame p95 为 71 ms，线性 framebuffer 为 58 ms；port 必须
  依据实测证据选择路径，不能假设紧凑输出一定更快。
