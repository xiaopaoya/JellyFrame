...
| `box-shadow` | Subset | First shadow becomes an approximate rounded translucent fill. Real blur and multiple shadows are not rasterized; combine lightweight shadows, borders and `radial-gradient()` highlights for soft hydrogel surfaces. |
