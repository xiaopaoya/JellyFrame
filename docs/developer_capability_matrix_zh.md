...
| Flex | 子集 | 简化 row 支持基础 grow/shrink/basis sizing、justify、align、gap 和可选 wrapping；不换行 column 使用相同的主轴/交叉轴 sizing controls。无完整 Flexbox 算法、反向方向、order、baseline alignment 或 min-content sizing。 |
