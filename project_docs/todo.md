...
- [ ] Complete the responsive-layout foundation audit against [the layout contract](../docs/responsive_layout_contract.md): keep the `300x300`, `320x240` and `172x320` matrix executable; prioritize explicit sizing, axis alignment, text measurement and diagnostics over new controls or browser-only declarations.
