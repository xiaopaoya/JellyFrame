...
and 172 x 320 validation targets. It is not a required system launcher and
does not install, remove or launch real apps.

The six icons are built from bounded CSS primitives: radial and conic gradients,
